...
// GlassPanel -- frosted-glass surface used for every panel on the System
...
// Split out of GlassCard on 2026-09-16: the landing page's GlassCard now has a
// different API (no title/depth), which broke this page's build.
